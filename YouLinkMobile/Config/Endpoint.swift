...
enum Endpoint{
    ...
    var path:String{
        ...
        case .getAllEvents: return "YouLinkMobileAPI/api/Event/GetAllEvents"
        case .exchangeRates: return "YouLinkMobileAPI/api/ExchangeRates/ExchangeRates"
        ...
        case .quickLinks:return "YouLinkMobileAPI/api/Menu/quick-links"
        }
    }
